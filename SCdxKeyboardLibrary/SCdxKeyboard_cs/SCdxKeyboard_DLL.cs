...
/// <summary>
/// 
/// The C# API and dll loader for the SCdxKeyboard DLL
/// 
...
namespace dxKbdInterfaceWrap
{
  ...
  internal static class SCdxKeyboard_DLL
  {
    ...
    internal static class UnsafeNativeMethods
    {
      ...
      #region SCdxKeyboard API calls 

      internal const string Module_DLL_Name = "SCdxKeyboard.dll";
